...
// src/types.ts
var urlApi = "/api";
var urlApiUser = `${urlApi}/.user`;
var urlApiUserLogin = `${urlApiUser}/login`;
var urlApiUserInfo = `${urlApiUser}/user`;
var urlApiAdminInfo = `${urlApiUser}/admin`;
var urlApiCheckRole = `${urlApiUser}/checkRole`;
var urlApiFutureUser = `${urlApiUser}/futureUsers`;
var urlApiUserInscription = `${urlApiUser}/inscription`;
var urlApiUserInscriptionValide = `${urlApiUser}/inscription/valideUser/:id`;
var urlApiUsersInfo = `${urlApiUser}/users`;
var urlServerServiceUser = "http://nginx/api";
var endPointServiceUserHello = `${urlServerServiceUser}/hello`;
var endPointServiceUserLogin = `${urlServerServiceUser}/login_check`;
var endPointServiceUserInfo = `${urlServerServiceUser}/user`;
var endPointServiceUserAdminInfo = `${urlServerServiceUser}/admin`;
var endPointServiceUserCheckRole = `${endPointServiceUserInfo}/check_role`;
var endPointServiceFutureUsers = `${urlServerServiceUser}/future-users`;
var endPointServiceUserInscription = `${urlServerServiceUser}/inscription`;
var endPointServiceUserInscriptionValide = `${endPointServiceUserInscription}/valide-user/`;
var endPointServiceUsersInfo = `${urlServerServiceUser}/users`;
var urlsAcceptedWithoutConnection = [
  urlApi,
  urlApiUser,
  urlApiUserLogin,
...
var checkToken_default = module.exports = function() {
...
var connection = (username, password, res) => {
...
var checkUserInfo = (token, res) => {
  import_axios.default.get(endPointServiceUserInfo, {
    headers: {
      Authorization: token
    }
  }).then((resp) => {
...
var inscription = (email, fisrtName, lastName, phone, country, res) => {
  import_axios.default.post(
...
var validation = (id, data, token, res) => {
  import_axios.default.post(
...
// src/services/user.ts
var initUrls = (app2) => {
  app2.get(urlApiUser, (_, res) => {
    import_axios2.default.get(endPointServiceUserHello).then((resp) => {
      res.json(resp.data);
    }).catch((error) => {
      res.status(error.response.status).json(error.response.data);
    });
  });
  app2.post(urlApiUserLogin, (req, res) => {
    const body = req.body;
    connection(body.username, body.password, res);
  });
  app2.get(urlApiUserInfo, (req, res) => {
    const token = req.header("Authorization");
    checkUserInfo(token, res);
  });
  app2.get(urlApiAdminInfo, (req, res) => {
    const token = req.header("Authorization");
    import_axios2.default.get(endPointServiceUserAdminInfo, {
      headers: {
  ...
  app2.post(urlApiCheckRole, (req, res) => {
    const body = req.body;
    const token = req.header("Authorization");
    checkRole(body.role, token, res);
  });
  app2.get(urlApiFutureUser, (req, res) => {
    import_axios2.default.get(endPointServiceFutureUsers, {
      headers: {
        Authorization: req.header("Authorization")
      }
    }).then((resp) => {
  ...
  app2.post(urlApiUserInscription, (req, res) => {
    const body = req.body;
    inscription(body.email, body.firstName, body.lastName, body.phone, body.country, res);
  });
  app2.post(urlApiUserInscriptionValide, (req, res) => {
    const id = req.params.id;
    const data = req.body;
    const token = req.header("Authorization");
    validation(id, data, token, res);
  });
  app2.get(urlApiUsersInfo, (req, res) => {
    import_axios2.default.get(endPointServiceUsersInfo, {
      headers: {
        Authorization: req.header("Authorization")
      }
    }).then((resp) => {
