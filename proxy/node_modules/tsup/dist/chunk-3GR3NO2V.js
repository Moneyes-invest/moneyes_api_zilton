...
var require_flat = _chunkOSC67C6Mjs.__commonJS.call(void 0, {
...
// src/cli-main.ts
var import_flat = _chunkOSC67C6Mjs.__toESM.call(void 0, require_flat());
...
async function main(options = {}) {
  ...
  cli.command("[...files]", "Bundle files", {
    ...
    if (!options.entry && files.length > 0) {
      options.entry = files.map(_chunkOSC67C6Mjs.slash);
    }
    if (flags.format) {
  ...
  cli.help();
  cli.version(_chunkW774UXFSjs.version);
