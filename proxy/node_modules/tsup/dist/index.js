...
var _chunkW774UXFSjs = require('./chunk-W774UXFS.js');
...
var require_consola = _chunkOSC67C6Mjs.__commonJS.call(void 0, {
  "node_modules/.pnpm/consola@2.15.3/node_modules/consola/dist/consola.js"(exports, module) {
    ...
    var D = u(_chunkOSC67C6Mjs.__require.call(void 0, "util"));
    var e = _chunkOSC67C6Mjs.__require.call(void 0, "path");
    var t = _chunkOSC67C6Mjs.__require.call(void 0, "fs");
    var r = u(_chunkOSC67C6Mjs.__require.call(void 0, "os"));
    var n = u(_chunkOSC67C6Mjs.__require.call(void 0, "tty"));
    function s(u2, D2) {
    ...
    var Gu = "undefined" != typeof __non_webpack_require__ ? __non_webpack_require__ : _chunkOSC67C6Mjs.__require;
    var zu = class {
      constructor(u2) {
        if (u2 && u2.log)
          this.logger = u2;
  ...
  return {
    ...
    setup(build2) {
      ...
      const getPostcssConfig = async () => {
        const loadConfig = _chunkOSC67C6Mjs.__require.call(void 0, "postcss-load-config");
        if (configCache) {
          return configCache;
        }
        try {
      ...
      build2.onLoad({ filter: /\.css$/ }, async (args) => {
        ...
        if (plugins && plugins.length > 0) {
          const postcss = _chunkOSC67C6Mjs.getPostcss.call(void 0, );
          if (!postcss) {
            return {
              errors: [
                {
  ...
  return {
    ...
    setup(build2) {
      ...
      build2.onLoad({ filter: /\.svelte$/ }, async (args) => {
        svelte = svelte || _chunkOSC67C6Mjs.localRequire.call(void 0, "svelte/compiler");
        if (!svelte) {
          return {
...
// src/esbuild/index.ts
var import_consola = _chunkOSC67C6Mjs.__toESM.call(void 0, require_consola());
...
var swcPlugin = ({ logger: logger2 }) => {
  return {
    name: "swc",
    setup(build2) {
      const swc = _chunkOSC67C6Mjs.localRequire.call(void 0, "@swc/core");
      if (!swc) {
        logger2.warn(
  ...
  return {
    ...
    setup(build2) {
      build2.onResolve({ filter: /\.node$/, namespace: "file" }, (args) => {
        const resolvedId = _chunkOSC67C6Mjs.__require.resolve(args.path, {
...
var generateExternal = async (external) => {
  ...
  for (const item of external) {
    ...
    const deps = await _chunkCTQOVGLWjs.getProductionDeps.call(void 0, pkgPath);
    result.push(...deps);
  }
  return result;
};
async function runEsbuild(options, {
  ...
  const pkg = await _chunkCTQOVGLWjs.loadPkg.call(void 0, process.cwd());
  ...
  try {
    result = await _esbuild.build.call(void 0, {
      ...
      plugins: esbuildPlugins.filter(_chunkOSC67C6Mjs.truthy),
      define: {
  ...
  if (result && result.warnings && !_chunkCTQOVGLWjs.getSilent.call(void 0, )) {
...
var es5 = () => {
  ...
  return {
    ...
    async renderChunk(code, info) {
      ...
      const swc = _chunkOSC67C6Mjs.localRequire.call(void 0, "@swc/core");
      if (!swc) {
        throw new (0, _chunkQAQ2Z76Ijs.PrettyError)(
...
var isInPublicDir = (publicDir, filePath) => {
  if (!publicDir)
    return false;
  const publicPath = _chunkOSC67C6Mjs.slash.call(void 0, 
    _path2.default.resolve(publicDir === true ? "public" : publicDir)
  );
  return _chunkOSC67C6Mjs.slash.call(void 0, _path2.default.resolve(filePath)).startsWith(`${publicPath}/`);
};
  ...
  return {
    ...
    async renderChunk(code, info) {
      if (minifyOptions !== "terser" || !/\.(cjs|js|mjs)$/.test(info.path))
        return;
      const terser = _chunkOSC67C6Mjs.localRequire.call(void 0, "terser");
      if (!terser) {
        throw new (0, _chunkQAQ2Z76Ijs.PrettyError)(
...
var normalizeOptions = async (logger2, optionsFromConfigFile, optionsOverride) => {
  ...
  if (!entry || Object.keys(entry).length === 0) {
    throw new (0, _chunkQAQ2Z76Ijs.PrettyError)(`No input files, try "tsup <your-file>" instead`);
  }
  if (Array.isArray(entry)) {
    options.entry = await _globby2.default.call(void 0, entry);
    if (!options.entry || options.entry.length === 0) {
      throw new (0, _chunkQAQ2Z76Ijs.PrettyError)(`Cannot find ${entry}`);
    } else {
    ...
    Object.keys(entry).forEach((alias) => {
      ...
      if (!_fs2.default.existsSync(filename)) {
        throw new (0, _chunkQAQ2Z76Ijs.PrettyError)(`Cannot find ${alias}: ${filename}`);
      }
    });
    options.entry = entry;
  ...
  if (tsconfig) {
    ...
    throw new (0, _chunkQAQ2Z76Ijs.PrettyError)(`Cannot find tsconfig: ${options.tsconfig}`);
  }
  if (!options.target) {
...
async function build(_options) {
  const config = _options.config === false ? {} : await _chunkCTQOVGLWjs.loadTsupConfig.call(void 0, 
    process.cwd(),
  ...
  await Promise.all(
    [...Array.isArray(configData) ? configData : [configData]].map(
      async (item) => {
        ...
        logger2.info("CLI", `tsup v${_chunkW774UXFSjs.version}`);
        if (config.path) {
        ...
        const mainTasks = async () => {
          ...
          if (!((_a = options.dts) == null ? void 0 : _a.only)) {
            ...
            let depsHash = await _chunkCTQOVGLWjs.getAllDepsHash.call(void 0, process.cwd());
            ...
            const debouncedBuildAll = _chunkOSC67C6Mjs.debouncePromise.call(void 0, 
              () => {
                return buildAll();
              },
              100,
              _chunkQAQ2Z76Ijs.handleError
            );
            const buildAll = async () => {
              ...
              if (options.clean) {
                ...
                await _chunkOSC67C6Mjs.removeFiles.call(void 0, 
                  ["**/*", ...extraPatterns],
                  options.outDir
                );
            ...
            const startWatcher = async () => {
              ...
              watcher.on("all", async (type, file) => {
                file = _chunkOSC67C6Mjs.slash.call(void 0, file);
                ...
                if (options.watch === true) {
                  if (file === "package.json" && !buildDependencies.has(file)) {
                    const currentHash = await _chunkCTQOVGLWjs.getAllDepsHash.call(void 0, process.cwd());
