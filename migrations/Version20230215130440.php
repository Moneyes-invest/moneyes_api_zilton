 ...
 */
final class Version20230215130440 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE device (id INT NOT NULL, user_id UUID DEFAULT NULL, os_version VARCHAR(255) DEFAULT NULL, lang VARCHAR(255) DEFAULT NULL, os_name VARCHAR(255) DEFAULT NULL, device_udid VARCHAR(255) DEFAULT NULL, device_type VARCHAR(255) DEFAULT NULL, device_name VARCHAR(255) DEFAULT NULL, device_model VARCHAR(255) DEFAULT NULL, app_version VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
