 ...
 */
final class Version20230118100300 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE holding (id INT NOT NULL, id_user_id UUID NOT NULL, id_currency_id UUID NOT NULL, id_exchange_id UUID NOT NULL, quantity DOUBLE PRECISION NOT NULL, average_purchase_price DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE transaction (id UUID NOT NULL, id_exchange_id UUID NOT NULL, id_user_id UUID NOT NULL, id_currency_id UUID NOT NULL, date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, type VARCHAR(255) NOT NULL, order_direction VARCHAR(255) NOT NULL, fees DOUBLE PRECISION NOT NULL, price DOUBLE PRECISION NOT NULL, quantity DOUBLE PRECISION NOT NULL, exchange_id INT DEFAULT NULL, PRIMARY KEY(id))');
