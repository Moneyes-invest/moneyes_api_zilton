 ...
 */
final class Version20230324151306 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE asset (id UUID NOT NULL, code VARCHAR(10) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE transfer (id INT NOT NULL, asset_id UUID NOT NULL, asset_fees_id UUID DEFAULT NULL, account_id UUID NOT NULL, date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, quantity DOUBLE PRECISION NOT NULL, fees DOUBLE PRECISION DEFAULT NULL, external_transfer_id VARCHAR(255) DEFAULT NULL, type VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('COMMENT ON COLUMN transfer.asset_id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN transfer.asset_fees_id IS \'(DC2Type:uuid)\'');
