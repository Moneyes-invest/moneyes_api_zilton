...
class Transfer(models.Model):
    id = models.IntegerField(primary_key=True)
    asset = models.ForeignKey(Asset, models.DO_NOTHING, related_name='asset_transfer')
    asset_fees = models.ForeignKey(Asset, models.DO_NOTHING, blank=True, null=True, related_name='asset_fees_transfer')
    account = models.ForeignKey(Account, models.DO_NOTHING)
    date = models.DateTimeField()
    quantity = models.FloatField()
